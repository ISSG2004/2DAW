...
<body>
    <?php
    if ((isset($_REQUEST['buscar'])) && (!empty($_REQUEST["TxtBusq"]))) {
        echo"<h1>Formualrio simple. Resultados del formulario</h1>
        ...
        echo"</ul>";
        echo " <a href='./Ejercicio5.php'>[Nueva búsqueda]</a>";
    }else{
    ?>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <fieldset>
                ...
                <?php
                if (isset($_REQUEST['buscar']) && empty($_REQUEST["TxtBusq"])) {
                    echo "<p style='color:red'>¡Debe introducir el texto de búsqueda!</p>";
                }
                ?>
                <br>
