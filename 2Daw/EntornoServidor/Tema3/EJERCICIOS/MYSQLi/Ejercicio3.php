...
<body>
    <?php
        ...
        if ($llamadaBD->connect_errno==null) {
            ...
            while ($registro = mysqli_fetch_array($consulta)) {
                echo"<tr>";
                echo "<td>".$registro['titulo']."</td>"."<td>".$registro['texto']."</td>"."<td>".$registro['categoria']."</td>"."<td>".$registro['fecha']."</td><td>"." <input type='checkbox' name='borrarNoticia[]' value='$registro['id']'>"."</td>" ;
                echo "</tr>";
            }
            echo "</table>";
    ...
    ?>
    <input type="submit" name="borrarDatos" id="borrarDatos" value="Eliminar noticias marcadas">
    <?php
    }
    ?>
</body>
